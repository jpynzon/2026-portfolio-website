...
export default defineNuxtConfig({
  ...
  modules: ['@pinia/nuxt', '@vueuse/motion/nuxt', '@nuxt/image', '@nuxt/content', '@vercel/analytics/nuxt', '@vercel/speed-insights'],
  components: [
    {
      path: '~/components',
      pathPrefix: false
  ...
  runtimeConfig: {
    public: {
      ...
      gaId: process.env.NUXT_PUBLIC_GA_ID || 'G-ZWWMZ1YJ0V',
      turnstile: {
